...
namespace Blazor.Blello.DragAndDrop
{
    public class Draggable<TItem> : ComponentBase
    {
        ...
        protected override void BuildRenderTree(Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(c++, "ondragstart", Microsoft.AspNetCore.Components.EventCallback.Factory.Create<Microsoft.AspNetCore.Components.Web.DragEventArgs>(this, MyDragStart));
            builder.AddAttribute(c++, "ondragend", Microsoft.AspNetCore.Components.EventCallback.Factory.Create<Microsoft.AspNetCore.Components.Web.DragEventArgs>(this, MyDragEnd));
            if (!(OnDragOver is null))
            {
                c = 20; //Ensure the attribute always has the same sequence
                builder.AddAttribute(c++, "ondragover", Microsoft.AspNetCore.Components.EventCallback.Factory.Create<Microsoft.AspNetCore.Components.Web.DragEventArgs>(this, MyDragOver));
            }
